...
public class API_Search extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((DatumAdapter) m_adapter).setOnItemClickListener(new DatumAdapter.DatumClickListener() {
            ...
            public void onItemClick(int position, View v) {
                ...
                Datum dat = ((DatumAdapter) m_adapter).getItem(position);
                concatDat(dat);
            }
        });
    ...
    // Concatenate Data from Datum
    public void concatDat(Datum datum){
        Intent intent = new Intent(getApplicationContext(), ResultDisplayActivity.class);
        intent.putExtra("img", datum.imageUrl());
        intent.putExtra("date", datum.date());
        intent.putExtra("title", datum.title());
        intent.putExtra("txt", datum.text());
